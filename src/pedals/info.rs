...
impl PedalInfo {
    pub fn parameters_from_pedal(pedal: &dyn PedalTrait, name: Option<String>) -> Self {
        ...
        let params: Vec<(String, PedalParameter)> = pedal
            .get_parameters()
            .into_iter()
        ...
        for (name, param) in &params {
            ...
            match param.value.clone() {
                ...
                PedalParameterValue::Int(_) => {
                    pedal_info
                        .parameters
                        .insert(param_name, ParameterInfo::Numerical(param.clone()));
                }
                ...
                PedalParameterValue::Oscillator(o) => {
                    pedal_info
                        .parameters
                        .insert(param_name, ParameterInfo::Oscillator(o));
                }
            }
        }
...
impl Info {
    pub fn pedal_defaults() -> Self {
        ...
        for pedal_type in PedalDiscriminants::iter() {
            ...
            let pedal_info = PedalInfo::parameters_from_pedal(
                &init_pedal,
                Some(pedal_type.display_name().to_string()),
            );

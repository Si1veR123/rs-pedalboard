use eframe::egui::{self, Color32, Id, WidgetText};
...
pub fn pedal_knob(ui: &mut egui::Ui, name: impl Into<WidgetText>, parameter: &PedalParameter, at: egui::Vec2, size: f32) -> Option<PedalParameterValue> {

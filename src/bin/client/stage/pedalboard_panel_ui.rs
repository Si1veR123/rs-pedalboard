...
pub fn pedalboard_stage_panel(screen: &mut PedalboardStageScreen, ui: &mut egui::Ui) {
    ...
    ui.columns(3, |columns| {
        if columns[0]
            .add_sized(buttons_row_size, egui::Button::new("New Pedalboard"))
            .clicked()
        {
        ...
        if columns[1]
            .add_sized(buttons_row_size, egui::Button::new("Save To Song"))
            .clicked()
        {
        ...
        if columns[2]
            .add_sized(buttons_row_size, egui::Button::new("Clear Stage"))
            .clicked()
        {
            *screen.state.pedalboards.active_pedalboardstage.borrow_mut() =
                PedalboardSet::default();
        ...
        .show(ui, |ui| {
                        ...
                        |ui| {
                            ...
                            ui.columns(2, |columns| {
                                columns[0].horizontal_centered(|ui| {
                                    let (text_color, drag_icon_color) =
                                        if active_pedalboards.active_pedalboard == i {
                                    ...
                                    if ui
                                        .label(
                                            RichText::new(pedalboard.name.clone())
                                                .color(text_color),
                                        )
                                        .clicked()
                                    {
                                        screen.current_action =
                                            Some(CurrentAction::ChangeActive(i));
                                    }
                                });
                                ...
                                columns[1].allocate_ui_with_layout(
                                    ...
                                    |ui| {
                                        ...
                                        ui.menu_button("...", |ui| {
                                            ...
                                            let in_library = pedalboard_library.iter().any(
                                                |library_pedalboard| {
                                                    library_pedalboard.name == pedalboard.name
                                                },
                                            );
                                            if in_library {
                                                ui.label(
                                                ...
                                                if ui
                                                    .add(egui::Button::new(
                                                        RichText::new("Save To Library")
                                                            .text_style(egui::TextStyle::Heading),
                                                    ))
                                                    .clicked()
                                                {
                                                    screen.current_action =
                                                        Some(CurrentAction::SaveToLibrary(i));
                                                }
                                            }
                                            ui.add_space(2.0);
                                            ui.separator();
                                            ...
                                            if ui
                                                .add(egui::Button::new(
                                                    RichText::new("Remove From Stage")
                                                        .text_style(egui::TextStyle::Heading),
                                                ))
                                                .clicked()
                                            {
                                                screen.current_action =
                                                    Some(CurrentAction::Remove(i));
                                            }
                                            ui.add_space(2.0);
                                            ui.separator();
                                            ui.add_space(2.0);
                                            ...
                                            {
                                                screen.current_action =
                                                    Some(CurrentAction::DuplicateLinked(i));
                                            }
                                            ui.add_space(2.0);
                                            ui.separator();
                                            ui.add_space(2.0);
                                            if ui
                                                .add(egui::Button::new(
                                                    RichText::new("Duplicate New")
                                                        .text_style(egui::TextStyle::Heading),
                                                ))
                                                .clicked()
                                            {
                                                screen.current_action =
                                                    Some(CurrentAction::DuplicateNew(i));
                                            }
                                            ui.add_space(5.0);
                                        });
            ...
            if let Some(drag_update) = dnd_response.final_update() {
                    ...
                    && drag_update.from != drag_update.to
                {
                    ...
                    screen
                        .state
                        .move_pedalboard(drag_update.from, new_pedalboard_index, false);
                }
            }
        })
        .inner;
    ...
    match screen.current_action.take() {
        ...
        Some(CurrentAction::SaveToSong(mut song_name)) => {
            ...
            drop(active_pedalboards);
            let saved =
                screen.save_song_input_window(ui, "Save to Song", &mut song_name, &mut open);
        ...
        Some(CurrentAction::AddPedalboard) => {
            drop(active_pedalboards);
            drop(pedalboard_library);
            let unique_name = screen
                .state
                .pedalboards
                .unique_name("New Pedalboard".to_string());
